    ...
    <form on:submit|preventDefault={handleSubmit} class="mb-6">
        <div class="mb-4">
            ...
            <input 
                ...
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#AF8F6F]"
            />
        </div>
        <button 
            type="submit" 
            class="w-full bg-[#AF8F6F] text-white py-2 px-4 rounded-md hover:bg-[#AF8F6F] transition duration-300"
            disabled={loading}
        >
