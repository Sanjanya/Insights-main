...
<main class="flex">
  <div class="bg-[#FFFBF5] border border-[#74512D] size-3/4 h-96 m-4">
    ...
    <button class="p-4 pt-2 pb-2 bg-[#AF8F6F] text-slate-100 rounded-3xl" on:click={download}>
        Download CSV
      </button>
  </div>
  <div class="flex flex-col border border-[#74512D] w-1/4 h-96 m-4 p-4">
